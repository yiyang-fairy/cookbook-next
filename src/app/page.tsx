...
const swiperItems = [
  ...
  {
    id: 'swiper_2',
    image: 'https://images.unsplash.com/photo-1601128533718-374ffcca299b?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=3128&q=80',
    title: '轮播图2'
  },
  {
    id: 'swiper_3',
    image: 'https://images.unsplash.com/photo-1567945716310-4745a6b7844b?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=60',
    title: '轮播图3'
  }
];
...
export default function Home() {
  ...
  // 切换类型时加载
  useEffect(() => {
    if (!loading && activeKey !== RecipeType.ALL) {
      fetchRecipes(activeKey);
    }
  }, [activeKey, loading]);

  if (loading) {
    return <div className="w-full h-screen flex items-center justify-center">加载中...</div>;
  }

  return (
    <main className="flex h-screen flex-col">
      {/* 轮播图 */}
      <div className="h-[200px]"> {/* 给定固定高度 */}
          ...
          <div className="grid gap-4 p-4 relative">
            ...
            {recipes.map((recipe) => (
              ...
              >
                ...
                <p className="text-gray-600">烹饪时间: {recipe.cookingTime}分钟</p>
                <p className="text-gray-600">已被选择: {recipe.selectedCount}次</p>
                <p className="text-sm text-gray-400">更新时间: {recipe.updateTime}</p>
              </Link>
            ))}
          </div>
        </div>
